...
#define lcdCsL()	GPIOB->BRR =   GPIO_BRR_BR12;
#define lcdCsH()	GPIOB->BSRR =  GPIO_BSRR_BS12;

#define lcdWriteL()	GPIOB->BRR =   GPIO_BRR_BR13;
#define lcdWriteH()	GPIOB->BSRR =  GPIO_BSRR_BS13;

#define lcdReadH()	GPIOB->BSRR =  GPIO_BRR_BR14;
#define lcdReadL()	GPIOB->BRR =   GPIO_BSRR_BS14;

#define lcdBlcL()	GPIOC->BRR =   GPIO_BRR_BR11;
#define lcdBlcH()	GPIOC->BSRR =  GPIO_BSRR_BS11;

#define lcdRsL()	GPIOC->BRR =   GPIO_BRR_BR12;
#define lcdRsH()	GPIOC->BSRR =  GPIO_BSRR_BS12;

#define spiDatL()   GPIOB->BRR =   GPIO_BRR_BR15;


#define spiDatH()   GPIOB->BSRR =  GPIO_BSRR_BS15;

#define splClkL()   GPIOB->BRR =   GPIO_BRR_BR13;
#define spiClkH()   GPIOB->BSRR =  GPIO_BSRR_BS13;

#define spiClk()	GPIOB->BSRR =  GPIO_BSRR_BS13; \
    GPIOB->BRR  =  GPIO_BRR_BR13

#define wrPulse() 	GPIOB->BRR =  GPIO_BRR_BR13; \
