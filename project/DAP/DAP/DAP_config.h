...
// USART Port and I/O Pins
 ...
 ||   defined ( BOARD_STM32RF )
	...
	#define USART_CLOCK(state)		RCC_APB2PeriphClockCmd(RCC_APB2Periph_UART1, state)
	...
	#define USART_PORT			UART1
	#define USART_GPIO			GPIOA
	#define USART_TX_PIN		GPIO_Pin_9
	#define USART_RX_PIN		GPIO_Pin_10
	#define USART_IRQn			UART1_IRQn
	#define USART_IRQHandler	UART1_IRQHandler
  ...
  ||  defined ( STLINK_V21 )
	...
	#define USART_PORT			UART2
	#define USART_GPIO			GPIOA
	#define USART_TX_PIN		GPIO_Pin_2
	#define USART_RX_PIN		GPIO_Pin_3
	#define USART_IRQn			UART2_IRQn
	#define USART_IRQHandler	UART2_IRQHandler
	#define USART_BUFFER_SIZE	(256)	/*	Size of Receive and Transmit buffers MUST BE 2^n */
